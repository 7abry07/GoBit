...
func (t *Torrent) handleTrackerEvent(e TrackerEvent) {
	...
	case TrackerAnnounced:
		t.handleTrackerAnnounced(e)
	case TrackerScraped:
		t.handleTrackerScraped(e)
	}
}
...
func (t *Torrent) handleTrackerAnnounced(e TrackerAnnounced) {
	if e.Err != nil {
		e.Sender.Failure()
...
func (t *Torrent) handleTrackerScraped(e TrackerScraped) {}
